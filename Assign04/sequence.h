...
// FILE: sequence.h (part of the namespace CS3358_SP2019_A04)
// TEMPLATE CLASS PROVIDED: sequence<Item> (a container class for a list of
//   items, where each list may have a designated item called the current
//   item)
//
// TEMPLATE PARAMETER, TYPEDEFS and MEMBER CONSTANTS for the sequence class:
//   template <class Item>
//     sequence::Item is the data type of the items in the bag, also
//     defined as sequence<Item>::value_type
